...
use strict;
open IN, "/disk/zxl/database/miRanda/Database/miRNA_target.lst";
open IN2, "/disk/zxl/database/miRDB/miRNA_target.lst";
open IN3, "/disk/zxl/database/miRNA_target/miRNA_target.lst";
